        ...
        useCallback(() => {
            const fetchStats = async () => {
                try {
                    ...
                    setPacientesCount(response.data.pacientesAtivos);
                    setAgendamentosCount(response.data.agendamentosHoje);

                } catch (error) {
                    console.error("Erro ao buscar stats da home:", error);
        ...
        <View style={Estilo.container}>
            ...
            <View style={Estilo.blocos}>
                <View style={Estilo.blocodados}>
                    ...
                    {/* Lógica de Loading: Mostra o número ou um "carregando" */}
                    {isLoading ? (
                        <ActivityIndicator size="small" color="#2480F9" style={Estilo.loading} />
                    ) : (
                        <Text style={Estilo.numeroDado}>{pacientesCount}</Text>
                    )}
                </View>
                <View style={Estilo.blocodados}>
                    ...
                    {isLoading ? (
                        ...
                        <Text style={Estilo.numeroDado}>{agendamentosCount}</Text>
                    )}
                </View>
            </View>
